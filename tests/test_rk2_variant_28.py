...
`tools/rk2_variant_28.py`. Два ранних кандидата дали разные ответы; оба
опровергнуты оракулом.
...
def test_prefix_invariant_excludes_an_plus_one_bn_a():
    """Можно ли получить `aⁿ⁺¹bⁿa`?
...
# --------------------------------------------------------------------------
# Опровержение двух ранних кандидатов
# --------------------------------------------------------------------------


def test_both_early_candidates_are_refuted(exact):
    """Оба ранних ответа ошибаются на конкретных словах."""
    # Кандидат 1: L = {aⁿbᵐ | m ≥ n ≥ 1}
