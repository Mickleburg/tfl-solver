...
Публичный корпус не пополняется готовыми разборами актуальных вариантов
лабораторных и не настраивается под них заранее. Это не ограничение решателя:
если пользователь передаёт полное условие конкретной ЛР и явно просит её
решить, агент должен подготовить корректное решение и автономный проект.
