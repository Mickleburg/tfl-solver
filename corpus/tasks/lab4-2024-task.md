# ЛР4 (2024/25) — группы захвата в регексах

Условие из `ark2016/TFL`, файл `lab4/Task.md`. Текст преподавательский:
то же задание, что ЛР4 2025 («расширенные регексы»), и его уточняет issue #35.
Ценность — **разбалловка по этапам**, которой в наших материалах не было.
