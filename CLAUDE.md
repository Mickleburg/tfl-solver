...
Предметная база и проверенные приёмы: `corpus/knowledge/`.

Не восстанавливай удалённые личные материалы и атрибуцию частных источников.
Коммиты создавай только от `Mickleburg <yruloki@yandex.ru>`, без co-author и
без упоминания агента.
