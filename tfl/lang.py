...
Модуль построен вокруг одного основного приёма курса, повторяющегося в
официальных разборах и обезличенных контрольных примерах
(`corpus/knowledge/SOLUTION-PATTERNS.md`):
